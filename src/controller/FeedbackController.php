...
class FeedbackController
{
    ...
    private function getFeedback($id)
    {
        ...
        $response['body'] = json_encode(
            formatRes::getData(['feedbackId', 'userId', 'name', 'email', 'phone', 'address', 'content', 'isHandle', 'createdAt'], $result)
        );
        return $response;
    }
    ...
    private function updateFeedback()
    {
        ...
        $response['status_code_header'] = 'HTTP/1.1 200 OK';
        $response['body'] = json_encode(formatRes::getData(['feedbackId', 'userId', 'name', 'email', 'phone', 'address', 'content', 'isHandle', 'createdAt'], $input));
        return $response;
    }
