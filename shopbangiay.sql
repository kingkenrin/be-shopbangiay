...
INSERT INTO `invoice` (`invoiceId`, `userId`, `address`, `note`, `orderDate`, `state`, `totalPrice`) VALUES
...
(51, 18, 'https://res.cloudinary.com/dxtslecpc/image/upload/v1731261852/shopbangiayuit/degiay.png.png'),
(52, 18, 'https://res.cloudinary.com/dxtslecpc/image/upload/v1731261856/shopbangiayuit/magiay.png.png'),
(53, 18, 'https://res.cloudinary.com/dxtslecpc/image/upload/v1731261860/shopbangiayuit/tronggiay.png.png');
...
--
ALTER TABLE `detailinvoice`
  MODIFY `detailInvoiceId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `detailproduct`
--
ALTER TABLE `detailproduct`
  MODIFY `detailProductId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
--
ALTER TABLE `productotherimage`
  MODIFY `productOtherImageId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
